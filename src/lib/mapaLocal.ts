...
import { fetchSetores, fetchPontos, salvarEquipamentoDoPonto, removerEquipamentoDoPonto } from "@/lib/mapaData"
...
export async function pontosDoSetor(nivelId: string, setorId: string): Promise<Ponto[]> {
